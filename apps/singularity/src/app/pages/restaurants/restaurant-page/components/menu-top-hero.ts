...
@Component({
    ...
    <div class="flex flex-col gap-2">
        ...
        <div class="flex gap-2">
            ...
            <a routerLink="/admin/restaurant/{{menu().restaurant.id}}" class="hover:bg-slate-300 transition-all w-fit p-2 rounded-lg font-sans text-[1.2rem] flex items-center gap-2">
            ...
            <div class="relative w-full h-full min-h-[220px]">
                ...
                <div class="absolute gradient-selector w-full top-0 h-full rounded-xl flex flex-col p-6">
                    <div class="flex-1 flex items-start gap-2">
                        <a routerLink="/admin/restaurant/{{menu().restaurant.id}}/menu/{{menu().id}}">
