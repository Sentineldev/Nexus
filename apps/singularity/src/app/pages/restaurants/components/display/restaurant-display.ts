...
@Component({
    ...
    `,
    template: `
        <a routerLink="/admin/restaurant/{{restaurant().id}}/menus" class="transition-all hover:opacity-90 duration-300 border-slate-200 lg:w-[380px] flex flex-col gap-2 border-none">
