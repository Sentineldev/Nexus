...
@Component({
    ...
    <app-custom-dialog [dialogId]="dialogId()">
        <div class="p-6 bg-white m-auto lg:w-[600px] rounded-xl flex flex-col gap-4">
            <h1 class="text-center font-sans text-xl font-medium text-primary">Actualizar Empleado</h1>
            ...
            <form [formGroup]="formGroup" (ngSubmit)="onSubmitHandler()" class="w-full flex flex-col gap-6">
                <div class="flex flex-col gap-4">
                    ...
                    [id]="'identification'+this.employee().id"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <app-reactive-form-input
                        label="Nombres"
                        [id]="'firstNames'+this.employee().id"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        [id]="'personalEmail'+this.employee().id"
                        ...
                        [id]="'corporativeEmail'+this.employee().id"
                        [errors]="{ required: 'No puedes dejar este campo vacio', email: 'Ingrese un correo valido' }"
                        />
                    </div>
                    ...
                    [id]="'position'+this.employee().id"
                    [errors]="{ required: 'No puedes dejar este campo vacio' }"
                    />
                    <app-reactive-form-input
                    label="Departamento"
                    [control]="formGroup.controls.department"
                    [id]="'department'+this.employee().id"
                    [errors]="{ required: 'No puedes dejar este campo vacio' }"
                    />
                    <app-reactive-form-input
                    label="Cargo"
...
export default class UpdateUserModal implements OnInit {
    ...
    onSubmitHandler() {
        if (this.formGroup.valid) {
            ...
            this.repository.update(this.employee().id, body).subscribe((result) => {
                setTimeout(() => {
