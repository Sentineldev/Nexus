...
@Component({
    ...
    template: `
    <div class="grid grid-cols-4 gap-2 items-center justify-center text-slate-700">
        ...
        <p class="font-sans text-slate-700 text-[1.2rem] text-wrap break-words">{{client().email}}</p>
